 ...
 */
package lyzzcw.work.rpc.constant;
...
public class RpcConstants {
     ...
     * 基于加权hash算法的负载均衡策略
     */
    public static final String SERVICE_LOAD_BALANCER_HASH_WEIGHT = "hash_weight";
    /**
     * 基于源ip地址hash算法的负载均衡策略
     */
     ...
     * 最早连接淘汰策略
     */
    public static final String RPC_CONNECTION_DISUSE_STRATEGY_FIRST = "strategy_first";
     ...
     * 最少使用淘汰策略
     */
    public static final String RPC_CONNECTION_DISUSE_STRATEGY_LFU = "strategy_lfu";
     ...
     * 拒绝策略
     */
    public static final String RPC_CONNECTION_DISUSE_STRATEGY_REFUSE = "strategy_refuse";
