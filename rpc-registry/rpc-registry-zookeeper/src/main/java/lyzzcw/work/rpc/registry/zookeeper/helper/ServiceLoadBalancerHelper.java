 ...
 */
package lyzzcw.work.rpc.registry.zookeeper.helper;
...
public class ServiceLoadBalancerHelper {
    ...
    public static List<ServiceMeta> getServiceMetaList(List<ServiceInstance<ServiceMeta>> serviceInstances){
        ...
        //元数据列表有变动
        if (!CollectionUtils.isEqualCollection(tempServiceInstances, serviceInstances)){
     ...
     * 数据转换
     */
    public static List<ServiceMeta> getServiceMetaListFromInstance(List<ServiceInstance<ServiceMeta>> serviceInstances) {
